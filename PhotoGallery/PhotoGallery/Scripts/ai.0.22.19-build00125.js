...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        (function (_InternalMessageId) {
            ...
            _InternalMessageId[_InternalMessageId["NONUSRACT_FaileAddHandlerForOnBeforeUnload"] = 18] = "NONUSRACT_FaileAddHandlerForOnBeforeUnload";
            _InternalMessageId[_InternalMessageId["NONUSRACT_FaileSendQueuedTelemetry"] = 19] = "NONUSRACT_FaileSendQueuedTelemetry";
            _InternalMessageId[_InternalMessageId["NONUSRACT_FaileReportDataLoss"] = 20] = "NONUSRACT_FaileReportDataLoss";
        ...
        var DataLossAnalyzer = (function () {
            ...
            DataLossAnalyzer.reportLostItems = function () {
                try {
                    ...
                    ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_FaileReportDataLoss, "Failed to report data loss: " + ApplicationInsights.Util.getExceptionName(e), { exception: ApplicationInsights.Util.dump(e) }));
                }
                finally {
                    try {
        ...
        var Initialization = (function () {
            ...
            Initialization.prototype.emptyQueue = function () {
                try {
                    ...
                    var message = new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_FaileSendQueuedTelemetry, "Failed to send queued telemetry", properties);
            ...
            Initialization.prototype.addHousekeepingBeforeUnload = function (appInsightsInstance) {
                ...
                if (!appInsightsInstance.config.disableFlushOnBeforeUnload && ('onbeforeunload' in window)) {
                    ...
                    if (!Microsoft.ApplicationInsights.Util.addEventHandler('beforeunload', performHousekeeping)) {
                        Microsoft.ApplicationInsights._InternalLogging.throwInternalNonUserActionable(Microsoft.ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_FaileAddHandlerForOnBeforeUnload, 'Could not add handler for beforeunload'));
                    }
                }
            };
